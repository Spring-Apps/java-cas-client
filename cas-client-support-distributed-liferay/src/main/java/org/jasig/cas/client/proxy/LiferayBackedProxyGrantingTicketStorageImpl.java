 ...
 * @since 3.1.9
 */
public final class LiferayBackedProxyGrantingTicketStorageImpl extends AbstractEncryptedProxyGrantingTicketStorageImpl {

    public static final String CACHE_NAME = "edu.maine.cas.client.LiferayBackedProxyGrantingTicketStorageImpl.cache";

    private static final Logger LOG = LoggerFactory.getLogger(LiferayBackedProxyGrantingTicketStorageImpl.class);

    private PortalCache<String, String> cache;
